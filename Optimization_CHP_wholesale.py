...
xx_data = [electricity_generation[:300], electricity_sold[:300], electricity_bought[:300], fuel_consumption[:300], heat_generation[:300]]
xx_label = ["electricity\_generation", "electricity\_sold", "electricity\_bought", "fuel\_consumption", "heat\_generation"]

fig = plt.figure()
fig.suptitle("CHP with wholesale price")
ax = plt.subplot(111)
